...
inline
bool  TypedRichNode<UniqueName>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<UniqueName>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<UniqueName>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<UniqueName>().lookupFeature(vm, feature, value);
}
...
inline
UnstableNode  TypedRichNode<UniqueName>::label(VM vm) {
...
inline
UnstableNode  TypedRichNode<UniqueName>::arityList(VM vm) {
  return _self.access<UniqueName>().arityList(vm);
}

inline
UnstableNode  TypedRichNode<UniqueName>::clone(VM vm) {
  return _self.access<UniqueName>().clone(_self, vm);
}

inline
UnstableNode  TypedRichNode<UniqueName>::waitOr(VM vm) {
  return _self.access<UniqueName>().waitOr(vm);
}

inline
bool  TypedRichNode<UniqueName>::testRecord(VM vm, RichNode arity) {
  return _self.access<UniqueName>().testRecord(vm, arity);
}

inline
bool  TypedRichNode<UniqueName>::testTuple(VM vm, RichNode label, size_t width) {
  return _self.access<UniqueName>().testTuple(_self, vm, label, width);
}

inline
bool  TypedRichNode<UniqueName>::testLabel(VM vm, RichNode label) {
...
inline
bool  TypedRichNode<UniqueName>::equals(VM vm, RichNode right) {
  return _self.access<UniqueName>().equals(vm, right);
}

inline
int  TypedRichNode<UniqueName>::compareFeatures(VM vm, RichNode right) {
...
inline
UnstableNode  TypedRichNode<UniqueName>::serialize(VM vm, SE se) {
