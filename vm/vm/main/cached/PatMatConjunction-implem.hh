...
StaticArray<StableNode> TypedRichNode<PatMatConjunction>::getElementsArray() {
  return _self.access<PatMatConjunction>().getElementsArray();
}

StableNode& TypedRichNode<PatMatConjunction>::getElements(size_t i) {
...
inline
StableNode *  TypedRichNode<PatMatConjunction>::getElement(size_t index) {
  return _self.access<PatMatConjunction>().getElement(index);
}

inline
bool  TypedRichNode<PatMatConjunction>::equals(VM vm, RichNode right, WalkStack & stack) {
...
inline
UnstableNode  TypedRichNode<PatMatConjunction>::serialize(VM vm, SE se) {
