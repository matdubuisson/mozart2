...
StaticArray<UnstableNode> TypedRichNode<Object>::getElementsArray() {
  return _self.access<Object>().getElementsArray();
}

UnstableNode& TypedRichNode<Object>::getElements(size_t i) {
  return _self.access<Object>().getElements(i);
}

inline
Space *  TypedRichNode<Object>::home() {
...
inline
StableNode *  TypedRichNode<Object>::getFeaturesRecord() {
  return _self.access<Object>().getFeaturesRecord();
}

inline
bool  TypedRichNode<Object>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<Object>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<Object>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<Object>().lookupFeature(vm, feature, value);
}
...
inline
UnstableNode  TypedRichNode<Object>::getClass(VM vm) {
  return _self.access<Object>().getClass(vm);
}

inline
UnstableNode  TypedRichNode<Object>::attrGet(VM vm, RichNode attribute) {
  return _self.access<Object>().attrGet(_self, vm, attribute);
}

inline
void  TypedRichNode<Object>::attrPut(VM vm, RichNode attribute, RichNode value) {
  _self.access<Object>().attrPut(_self, vm, attribute, value);
}

inline
UnstableNode  TypedRichNode<Object>::attrExchange(VM vm, RichNode attribute, RichNode newValue) {
...
inline
void  TypedRichNode<Object>::getCallInfo(VM vm, size_t & arity, ProgramCounter & start, size_t & Xcount, StaticArray<StableNode> & Gs, StaticArray<StableNode> & Ks) {
  _self.access<Object>().getCallInfo(_self, vm, arity, start, Xcount, Gs, Ks);
}

inline
void  TypedRichNode<Object>::getDebugInfo(VM vm, atom_t & printName, UnstableNode & debugData) {
