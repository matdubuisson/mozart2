...
inline
bool  TypedRichNode<SmallInt>::equals(VM vm, RichNode right) {
  return _self.access<SmallInt>().equals(vm, right);
}

inline
int  TypedRichNode<SmallInt>::compareFeatures(VM vm, RichNode right) {
  return _self.access<SmallInt>().compareFeatures(vm, right);
}

inline
int  TypedRichNode<SmallInt>::compare(VM vm, RichNode right) {
...
inline
UnstableNode  TypedRichNode<SmallInt>::opposite(VM vm) {
  return _self.access<SmallInt>().opposite(vm);
}

inline
UnstableNode  TypedRichNode<SmallInt>::add(VM vm, RichNode right) {
  return _self.access<SmallInt>().add(vm, right);
}

inline
UnstableNode  TypedRichNode<SmallInt>::add(VM vm, nativeint b) {
  return _self.access<SmallInt>().add(vm, b);
}

inline
UnstableNode  TypedRichNode<SmallInt>::subtract(VM vm, RichNode right) {
  return _self.access<SmallInt>().subtract(vm, right);
}

inline
UnstableNode  TypedRichNode<SmallInt>::subtractValue(VM vm, nativeint b) {
  return _self.access<SmallInt>().subtractValue(vm, b);
}

inline
UnstableNode  TypedRichNode<SmallInt>::multiply(VM vm, RichNode right) {
  return _self.access<SmallInt>().multiply(vm, right);
}

inline
UnstableNode  TypedRichNode<SmallInt>::multiplyValue(VM vm, nativeint b) {
  return _self.access<SmallInt>().multiplyValue(vm, b);
}

inline
UnstableNode  TypedRichNode<SmallInt>::div(VM vm, RichNode right) {
  return _self.access<SmallInt>().div(vm, right);
}

inline
UnstableNode  TypedRichNode<SmallInt>::divValue(VM vm, nativeint b) {
  return _self.access<SmallInt>().divValue(vm, b);
}

inline
UnstableNode  TypedRichNode<SmallInt>::mod(VM vm, RichNode right) {
  return _self.access<SmallInt>().mod(vm, right);
}

inline
UnstableNode  TypedRichNode<SmallInt>::modValue(VM vm, nativeint b) {
  return _self.access<SmallInt>().modValue(vm, b);
}

inline
UnstableNode  TypedRichNode<SmallInt>::abs(VM vm) {
