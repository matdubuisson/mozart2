...
inline
Space *  TypedRichNode<GlobalName>::home() {
...
inline
bool  TypedRichNode<GlobalName>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<GlobalName>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<GlobalName>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<GlobalName>().lookupFeature(vm, feature, value);
}
...
inline
UnstableNode  TypedRichNode<GlobalName>::label(VM vm) {
...
inline
UnstableNode  TypedRichNode<GlobalName>::arityList(VM vm) {
  return _self.access<GlobalName>().arityList(vm);
}

inline
UnstableNode  TypedRichNode<GlobalName>::clone(VM vm) {
  return _self.access<GlobalName>().clone(_self, vm);
}

inline
UnstableNode  TypedRichNode<GlobalName>::waitOr(VM vm) {
  return _self.access<GlobalName>().waitOr(vm);
}

inline
bool  TypedRichNode<GlobalName>::testRecord(VM vm, RichNode arity) {
  return _self.access<GlobalName>().testRecord(vm, arity);
}

inline
bool  TypedRichNode<GlobalName>::testTuple(VM vm, RichNode label, size_t width) {
  return _self.access<GlobalName>().testTuple(_self, vm, label, width);
}

inline
bool  TypedRichNode<GlobalName>::testLabel(VM vm, RichNode label) {
  return _self.access<GlobalName>().testLabel(_self, vm, label);
}

inline
const UUID &  TypedRichNode<GlobalName>::getUUID() {
  return _self.access<GlobalName>().getUUID();
}

inline
int  TypedRichNode<GlobalName>::compareFeatures(VM vm, RichNode right) {
...
inline
GlobalNode *  TypedRichNode<GlobalName>::globalize(VM vm) {
