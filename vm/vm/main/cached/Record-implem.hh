...
StaticArray<StableNode> TypedRichNode<Record>::getElementsArray() {
  return _self.access<Record>().getElementsArray();
}

StableNode& TypedRichNode<Record>::getElements(size_t i) {
...
inline
StableNode *  TypedRichNode<Record>::getElement(size_t index) {
...
inline
UnstableNode  TypedRichNode<Record>::arityList(VM vm) {
  return _self.access<Record>().arityList(vm);
}

inline
UnstableNode  TypedRichNode<Record>::waitOr(VM vm) {
  return _self.access<Record>().waitOr(vm);
}

inline
StableNode *  TypedRichNode<Record>::getArity() {
  return _self.access<Record>().getArity();
}

inline
bool  TypedRichNode<Record>::equals(VM vm, RichNode right, WalkStack & stack) {
  return _self.access<Record>().equals(vm, right, stack);
}

inline
bool  TypedRichNode<Record>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<Record>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<Record>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<Record>().lookupFeature(vm, feature, value);
}
...
inline
UnstableNode  TypedRichNode<Record>::label(VM vm) {
  return _self.access<Record>().label(vm);
}

inline
UnstableNode  TypedRichNode<Record>::clone(VM vm) {
  return _self.access<Record>().clone(vm);
}

inline
bool  TypedRichNode<Record>::testRecord(VM vm, RichNode arity) {
  return _self.access<Record>().testRecord(vm, arity);
}

inline
bool  TypedRichNode<Record>::testTuple(VM vm, RichNode label, size_t width) {
  return _self.access<Record>().testTuple(vm, label, width);
}

inline
bool  TypedRichNode<Record>::testLabel(VM vm, RichNode label) {
...
inline
UnstableNode  TypedRichNode<Record>::serialize(VM vm, SE se) {
