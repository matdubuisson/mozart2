...
inline
StableNode *  TypedRichNode<FailedValue>::getUnderlying() {
...
inline
void  TypedRichNode<FailedValue>::addToSuspendList(VM vm, RichNode variable) {
...
inline
void  TypedRichNode<FailedValue>::bind(VM vm, RichNode src) {
