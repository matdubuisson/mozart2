...
inline
Space *  TypedRichNode<ReflectiveVariable>::home() {
  return _self.access<ReflectiveVariable>().home();
}

inline
void  TypedRichNode<ReflectiveVariable>::addToSuspendList(VM vm, RichNode variable) {
...
inline
void  TypedRichNode<ReflectiveVariable>::bind(VM vm, RichNode src) {
  _self.access<ReflectiveVariable>().bind(vm, src);
}

inline
void  TypedRichNode<ReflectiveVariable>::reflectiveBind(VM vm, RichNode src) {
  _self.access<ReflectiveVariable>().reflectiveBind(_self, vm, src);
}

inline
void  TypedRichNode<ReflectiveVariable>::bindReadOnly(VM vm, RichNode src) {
