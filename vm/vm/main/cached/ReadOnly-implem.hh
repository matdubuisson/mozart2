...
inline
StableNode *  TypedRichNode<ReadOnly>::getUnderlying() {
...
inline
bool  TypedRichNode<ReadOnly>::shouldWakeUpUnderSpace(VM vm, Space * space) {
  return _self.access<ReadOnly>().shouldWakeUpUnderSpace(vm, space);
}

inline
void  TypedRichNode<ReadOnly>::addToSuspendList(VM vm, RichNode variable) {
...
inline
void  TypedRichNode<ReadOnly>::bind(VM vm, RichNode src) {
