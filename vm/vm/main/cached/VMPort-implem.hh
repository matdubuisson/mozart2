...
inline
bool  TypedRichNode<VMPort>::equals(VM vm, RichNode right) {
...
inline
void  TypedRichNode<VMPort>::send(VM vm, RichNode value) {
  _self.access<VMPort>().send(vm, value);
}

inline
UnstableNode  TypedRichNode<VMPort>::sendReceive(VM vm, RichNode value) {
