...
inline
bool  TypedRichNode<String>::equals(VM vm, RichNode right) {
  return _self.access<String>().equals(vm, right);
}

inline
int  TypedRichNode<String>::compare(VM vm, RichNode right) {
...
inline
nativeint  TypedRichNode<String>::stringCharAt(VM vm, RichNode offset) {
  return _self.access<String>().stringCharAt(_self, vm, offset);
}

inline
UnstableNode  TypedRichNode<String>::stringAppend(VM vm, RichNode right) {
  return _self.access<String>().stringAppend(_self, vm, right);
}

inline
UnstableNode  TypedRichNode<String>::stringSlice(VM vm, RichNode from, RichNode to) {
  return _self.access<String>().stringSlice(_self, vm, from, to);
}

inline
void  TypedRichNode<String>::stringSearch(VM vm, RichNode from, RichNode needle, UnstableNode & begin, UnstableNode & end) {
  _self.access<String>().stringSearch(_self, vm, from, needle, begin, end);
}

inline
bool  TypedRichNode<String>::stringHasPrefix(VM vm, RichNode prefix) {
  return _self.access<String>().stringHasPrefix(vm, prefix);
}

inline
bool  TypedRichNode<String>::stringHasSuffix(VM vm, RichNode suffix) {
  return _self.access<String>().stringHasSuffix(vm, suffix);
}

inline
bool  TypedRichNode<String>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<String>().lookupFeature(_self, vm, feature, value);
}

inline
bool  TypedRichNode<String>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<String>().lookupFeature(_self, vm, feature, value);
}
