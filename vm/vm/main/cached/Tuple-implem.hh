...
StaticArray<StableNode> TypedRichNode<Tuple>::getElementsArray() {
  return _self.access<Tuple>().getElementsArray();
}

StableNode& TypedRichNode<Tuple>::getElements(size_t i) {
...
inline
StableNode *  TypedRichNode<Tuple>::getElement(size_t index) {
...
inline
UnstableNode  TypedRichNode<Tuple>::arityList(VM vm) {
  return _self.access<Tuple>().arityList(vm);
}

inline
UnstableNode  TypedRichNode<Tuple>::waitOr(VM vm) {
  return _self.access<Tuple>().waitOr(vm);
}

inline
bool  TypedRichNode<Tuple>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<Tuple>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<Tuple>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<Tuple>().lookupFeature(vm, feature, value);
}

inline
StableNode *  TypedRichNode<Tuple>::getLabel() {
  return _self.access<Tuple>().getLabel();
}

inline
bool  TypedRichNode<Tuple>::equals(VM vm, RichNode right, WalkStack & stack) {
...
inline
UnstableNode  TypedRichNode<Tuple>::label(VM vm) {
  return _self.access<Tuple>().label(vm);
}

inline
UnstableNode  TypedRichNode<Tuple>::clone(VM vm) {
  return _self.access<Tuple>().clone(vm);
}

inline
bool  TypedRichNode<Tuple>::testRecord(VM vm, RichNode arity) {
  return _self.access<Tuple>().testRecord(vm, arity);
}

inline
bool  TypedRichNode<Tuple>::testTuple(VM vm, RichNode label, size_t width) {
  return _self.access<Tuple>().testTuple(vm, label, width);
}

inline
bool  TypedRichNode<Tuple>::testLabel(VM vm, RichNode label) {
...
inline
UnstableNode  TypedRichNode<Tuple>::serialize(VM vm, SE se) {
