...
inline
bool  TypedRichNode<Atom>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<Atom>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<Atom>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<Atom>().lookupFeature(vm, feature, value);
}
...
inline
UnstableNode  TypedRichNode<Atom>::label(VM vm) {
...
inline
UnstableNode  TypedRichNode<Atom>::arityList(VM vm) {
  return _self.access<Atom>().arityList(vm);
}

inline
UnstableNode  TypedRichNode<Atom>::clone(VM vm) {
  return _self.access<Atom>().clone(_self, vm);
}

inline
UnstableNode  TypedRichNode<Atom>::waitOr(VM vm) {
  return _self.access<Atom>().waitOr(vm);
}

inline
bool  TypedRichNode<Atom>::testRecord(VM vm, RichNode arity) {
  return _self.access<Atom>().testRecord(vm, arity);
}

inline
bool  TypedRichNode<Atom>::testTuple(VM vm, RichNode label, size_t width) {
  return _self.access<Atom>().testTuple(_self, vm, label, width);
}

inline
bool  TypedRichNode<Atom>::testLabel(VM vm, RichNode label) {
...
inline
bool  TypedRichNode<Atom>::equals(VM vm, RichNode right) {
  return _self.access<Atom>().equals(vm, right);
}

inline
int  TypedRichNode<Atom>::compareFeatures(VM vm, RichNode right) {
...
inline
int  TypedRichNode<Atom>::compare(VM vm, RichNode right) {
