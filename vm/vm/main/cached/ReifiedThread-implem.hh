...
inline
bool  TypedRichNode<ReifiedThread>::equals(VM vm, RichNode right) {
  return _self.access<ReifiedThread>().equals(vm, right);
}

inline
Runnable *  TypedRichNode<ReifiedThread>::value() {
...
inline
bool  TypedRichNode<ReifiedThread>::shouldWakeUpUnderSpace(VM vm, Space * space) {
...
inline
ThreadPriority  TypedRichNode<ReifiedThread>::getThreadPriority(VM vm) {
  return _self.access<ReifiedThread>().getThreadPriority(vm);
}

inline
void  TypedRichNode<ReifiedThread>::setThreadPriority(VM vm, ThreadPriority priority) {
  _self.access<ReifiedThread>().setThreadPriority(vm, priority);
}

inline
void  TypedRichNode<ReifiedThread>::injectException(VM vm, RichNode exception) {
