...
inline
UnstableNode  TypedRichNode<FailedSpace>::askSpace(VM vm) {
  return _self.access<FailedSpace>().askSpace(vm);
}

inline
UnstableNode  TypedRichNode<FailedSpace>::askVerboseSpace(VM vm) {
  return _self.access<FailedSpace>().askVerboseSpace(vm);
}

inline
UnstableNode  TypedRichNode<FailedSpace>::mergeSpace(VM vm) {
  return _self.access<FailedSpace>().mergeSpace(vm);
}

inline
void  TypedRichNode<FailedSpace>::commitSpace(VM vm, RichNode value) {
  _self.access<FailedSpace>().commitSpace(vm, value);
}

inline
UnstableNode  TypedRichNode<FailedSpace>::cloneSpace(VM vm) {
