...
StaticArray<StableNode> TypedRichNode<Arity>::getElementsArray() {
  return _self.access<Arity>().getElementsArray();
}

StableNode& TypedRichNode<Arity>::getElements(size_t i) {
...
inline
StableNode *  TypedRichNode<Arity>::getLabel() {
...
inline
StableNode *  TypedRichNode<Arity>::getElement(size_t index) {
  return _self.access<Arity>().getElement(index);
}

inline
bool  TypedRichNode<Arity>::equals(VM vm, RichNode right, WalkStack & stack) {
  return _self.access<Arity>().equals(vm, right, stack);
}

inline
bool  TypedRichNode<Arity>::lookupFeature(VM vm, RichNode feature, size_t & offset) {
...
inline
UnstableNode  TypedRichNode<Arity>::serialize(VM vm, SE se) {
