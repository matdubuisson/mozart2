...
StaticArray<UnstableNode> TypedRichNode<Array>::getElementsArray() {
  return _self.access<Array>().getElementsArray();
}

UnstableNode& TypedRichNode<Array>::getElements(size_t i) {
  return _self.access<Array>().getElements(i);
}

inline
Space *  TypedRichNode<Array>::home() {
  return _self.access<Array>().home();
}

inline
bool  TypedRichNode<Array>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<Array>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<Array>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<Array>().lookupFeature(vm, feature, value);
}
...
inline
void  TypedRichNode<Array>::dotAssign(VM vm, RichNode feature, RichNode newValue) {
  _self.access<Array>().dotAssign(_self, vm, feature, newValue);
}

inline
UnstableNode  TypedRichNode<Array>::dotExchange(VM vm, RichNode feature, RichNode newValue) {
...
inline
UnstableNode  TypedRichNode<Array>::arrayLow(VM vm) {
  return _self.access<Array>().arrayLow(vm);
}

inline
UnstableNode  TypedRichNode<Array>::arrayHigh(VM vm) {
  return _self.access<Array>().arrayHigh(vm);
}

inline
UnstableNode  TypedRichNode<Array>::arrayGet(VM vm, RichNode index) {
  return _self.access<Array>().arrayGet(_self, vm, index);
}

inline
void  TypedRichNode<Array>::arrayPut(VM vm, RichNode index, RichNode value) {
  _self.access<Array>().arrayPut(_self, vm, index, value);
}

inline
UnstableNode  TypedRichNode<Array>::arrayExchange(VM vm, RichNode index, RichNode newValue) {
