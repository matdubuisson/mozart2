...
StaticArray<StableNode> TypedRichNode<PatMatOpenRecord>::getElementsArray() {
  return _self.access<PatMatOpenRecord>().getElementsArray();
}

StableNode& TypedRichNode<PatMatOpenRecord>::getElements(size_t i) {
...
inline
StableNode *  TypedRichNode<PatMatOpenRecord>::getElement(size_t index) {
  return _self.access<PatMatOpenRecord>().getElement(index);
}

inline
StableNode *  TypedRichNode<PatMatOpenRecord>::getArity() {
...
inline
UnstableNode  TypedRichNode<PatMatOpenRecord>::serialize(VM vm, SE se) {
