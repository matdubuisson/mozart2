...
inline
bool  TypedRichNode<Boolean>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<Boolean>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<Boolean>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<Boolean>().lookupFeature(vm, feature, value);
}
...
inline
UnstableNode  TypedRichNode<Boolean>::label(VM vm) {
...
inline
UnstableNode  TypedRichNode<Boolean>::arityList(VM vm) {
  return _self.access<Boolean>().arityList(vm);
}

inline
UnstableNode  TypedRichNode<Boolean>::clone(VM vm) {
  return _self.access<Boolean>().clone(_self, vm);
}

inline
UnstableNode  TypedRichNode<Boolean>::waitOr(VM vm) {
  return _self.access<Boolean>().waitOr(vm);
}

inline
bool  TypedRichNode<Boolean>::testRecord(VM vm, RichNode arity) {
  return _self.access<Boolean>().testRecord(vm, arity);
}

inline
bool  TypedRichNode<Boolean>::testTuple(VM vm, RichNode label, size_t width) {
  return _self.access<Boolean>().testTuple(_self, vm, label, width);
}

inline
bool  TypedRichNode<Boolean>::testLabel(VM vm, RichNode label) {
...
inline
bool  TypedRichNode<Boolean>::equals(VM vm, RichNode right) {
  return _self.access<Boolean>().equals(vm, right);
}

inline
int  TypedRichNode<Boolean>::compareFeatures(VM vm, RichNode right) {
...
inline
UnstableNode  TypedRichNode<Boolean>::serialize(VM vm, SE se) {
