...
inline
Space *  TypedRichNode<Variable>::home() {
  return _self.access<Variable>().home();
}

inline
void  TypedRichNode<Variable>::addToSuspendList(VM vm, RichNode variable) {
...
inline
bool  TypedRichNode<Variable>::shouldWakeUpUnderSpace(VM vm, Space * space) {
  return _self.access<Variable>().shouldWakeUpUnderSpace(vm, space);
}

inline
void  TypedRichNode<Variable>::bind(VM vm, RichNode src) {
