...
inline
bool  TypedRichNode<Unit>::lookupFeature(VM vm, RichNode feature, nullable<UnstableNode &> value) {
  return _self.access<Unit>().lookupFeature(vm, feature, value);
}

inline
bool  TypedRichNode<Unit>::lookupFeature(VM vm, nativeint feature, nullable<UnstableNode &> value) {
  return _self.access<Unit>().lookupFeature(vm, feature, value);
}
...
inline
UnstableNode  TypedRichNode<Unit>::label(VM vm) {
...
inline
UnstableNode  TypedRichNode<Unit>::arityList(VM vm) {
  return _self.access<Unit>().arityList(vm);
}

inline
UnstableNode  TypedRichNode<Unit>::clone(VM vm) {
  return _self.access<Unit>().clone(_self, vm);
}

inline
UnstableNode  TypedRichNode<Unit>::waitOr(VM vm) {
  return _self.access<Unit>().waitOr(vm);
}

inline
bool  TypedRichNode<Unit>::testRecord(VM vm, RichNode arity) {
  return _self.access<Unit>().testRecord(vm, arity);
}

inline
bool  TypedRichNode<Unit>::testTuple(VM vm, RichNode label, size_t width) {
  return _self.access<Unit>().testTuple(_self, vm, label, width);
}

inline
bool  TypedRichNode<Unit>::testLabel(VM vm, RichNode label) {
  return _self.access<Unit>().testLabel(_self, vm, label);
}

inline
bool  TypedRichNode<Unit>::equals(VM vm, RichNode right) {
  return _self.access<Unit>().equals(vm, right);
}

inline
int  TypedRichNode<Unit>::compareFeatures(VM vm, RichNode right) {
...
inline
UnstableNode  TypedRichNode<Unit>::serialize(VM vm, SE se) {
